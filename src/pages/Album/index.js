      ...
      <div className="SelectMainContainer">
        <div className="cardselectcontainer">
          {(album || {}).images ? (
            ...
            <div className="teste">
              <img className="imgselect" src={logo} alt="Foto do albuma" />
            </div>
          )}
          <h2>{(album || {}).name}</h2>
        </div>
              ...
              <div className="ContainerSearch">
                ...
                {tracks.map((track) => (
                  ...
                  >
                    ...
                    <div className="searchname">{track.name}</div>
                    <div className="searchtype">{track.type}</div>
                    <div
                      id={"Progress" + track.id}
                      className="ProgressMusic DisplayPause"
                    >
                      <div
                        id={"ProgressBar" + track.id}
                        className="musicprogressbar timermusic pauseanimation"
                      ></div>
                    </div>
